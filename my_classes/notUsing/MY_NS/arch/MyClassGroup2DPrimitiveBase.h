...
namespace MY_NS_MODEL
{
	...
	struct MyStrVertexInfo
	{
		...
		MyClassVertex *pVertex;		//указательна вершину
	...
	class MyClassGroup2DPrimitiveBase: public MyClassMessageReceiver, public MyClassMessageSender
	{
	public:
	...
	public:
		MyClassGroup2DPrimitiveBase(void);
		MyClassGroup2DPrimitiveBase(const MyClassGroup2DPrimitiveBase & _MyClassGroup2DPrimitiveBaseObj);
		//опрератор присвоения
		void operator =(const MyClassGroup2DPrimitiveBase & _MyClassGroup2DPrimitiveBaseObj);

...
namespace MY_NS_MODEL
{
	...
	MyClassGroup2DPrimitiveBase::MyClassGroup2DPrimitiveBase(void)
	{
		arr2DPrimitive=0;
		num2DPrimitives=0;
		m_isClipped=false;
	...
	MyClassGroup2DPrimitiveBase::MyClassGroup2DPrimitiveBase(const MyClassGroup2DPrimitiveBase & _MyClassGroup2DPrimitiveBaseObj)
	{
		//не закреплены
		m_isClipped=false;

		arr2DPrimitive=0;
		num2DPrimitives=_MyClassGroup2DPrimitiveBaseObj.num2DPrimitives;
		if (num2DPrimitives>0)
		{
			arr2DPrimitive=new MyClass2DPrimitive*[num2DPrimitives];
			for(unsigned int i=0; i<num2DPrimitives; i++)
			{
				arr2DPrimitive[i]=new MyClass2DPrimitive(*(_MyClassGroup2DPrimitiveBaseObj.arr2DPrimitive[i]));
				arr2DPrimitive[i]->RegMessReceiver(this);
			}
		}
		FormVerticesNeighboursGroup();
		//если в передаваемом объекте вершины сгруппированы
		if (_MyClassGroup2DPrimitiveBaseObj.m_isClipped)
		{
			//сделать с текущим объектом тоже
			ClipVerticesNeighboursGroup();
		}
		o_cleaning=false;
		m_isSorted=_MyClassGroup2DPrimitiveBaseObj.IsSorted();
	}
	void MyClassGroup2DPrimitiveBase::operator =(const MyClassGroup2DPrimitiveBase & _MyClassGroup2DPrimitiveBaseObj)
	{
		Clear();
		num2DPrimitives=_MyClassGroup2DPrimitiveBaseObj.GetNum2DPrimitives();
		if (num2DPrimitives>0)
		{
			arr2DPrimitive=new MyClass2DPrimitive*[num2DPrimitives];
			for(unsigned int i=0; i<num2DPrimitives; i++)
			{
				arr2DPrimitive[i]=new MyClass2DPrimitive(*(_MyClassGroup2DPrimitiveBaseObj[i]));
				arr2DPrimitive[i]->RegMessReceiver(this);
			}
			FormVerticesNeighboursGroup();
			if (_MyClassGroup2DPrimitiveBaseObj.IsClipped())
			{
				//сделать с текущим объектом тоже
				ClipVerticesNeighboursGroup();
			}
	...
	unsigned int MyClassGroup2DPrimitiveBase::GetNum2DPrimitives()const
	{
		return num2DPrimitives;
	}
	MyClass2DPrimitive * MyClassGroup2DPrimitiveBase::operator [](unsigned int num)
	{
		if (!arr2DPrimitive) return 0;
		if (num>=num2DPrimitives) num=num2DPrimitives-1;
		return arr2DPrimitive[num];
	}
	const MyClass2DPrimitive * MyClassGroup2DPrimitiveBase::operator [](unsigned int num)const
	{
		if (!arr2DPrimitive) return 0;
		if (num>=num2DPrimitives) num=num2DPrimitives-1;
		return arr2DPrimitive[num];
	...
	void MyClassGroup2DPrimitiveBase::Add2DPrimitive(const MyClass2DPrimitive *_MyClass2DPrimitiveObj, int pos)
	{
	...
	void MyClassGroup2DPrimitiveBase::Remove2DPrimitive(unsigned int pos)
	{
	...
	void MyClassGroup2DPrimitiveBase::Clear()
	{
		if (arr2DPrimitive)	
		{
			o_cleaning=true;
	...
	bool MyClassGroup2DPrimitiveBase::Validate()
	{
		for(unsigned int i=0; i<num2DPrimitives; i++)
	...
	void MyClassGroup2DPrimitiveBase::MessageReseive(MyClassMessage _message, MyClassMessageSender * fromWho)
	{
		if (_message.message==change2DPrimitive)
		{
			if (!m_isClipped)
			{
				...
				{
					MyTypeArrVerticesNeighboursGroup::iterator iter=ArrVerticesNeighboursGroup.begin();
	...
	//const MyStrOldValidInfo & MyClassGroup2DPrimitiveBase::GetOldValidInfo()const
	//{
	//	return oldValidInfo;
	//}

	void MyClassGroup2DPrimitiveBase::CalcNormals()
	{
		if (num2DPrimitives==0) return;
	...
	void MyClassGroup2DPrimitiveBase::FormVerticesNeighboursGroup()
	{
		if (num2DPrimitives==0) return;
	...
	void MyClassGroup2DPrimitiveBase::ClipVerticesNeighboursGroup()
	{
		if (num2DPrimitives==0) return;
	...
	void MyClassGroup2DPrimitiveBase::UnClipVerticesNeighboursGroup()
	{
		if (!m_isClipped) return;
	...
	bool MyClassGroup2DPrimitiveBase::IsClipped()const
	{
		return m_isClipped;
	}
	//bool MyClassGroup2DPrimitiveBase::IsFormedVerticesNeighboursGroup()const
	//{
	//	return m_isFormedVerticesNeighboursGroup;
	//}
	bool MyClassGroup2DPrimitiveBase::IsSorted()const
	{
		return m_isSorted;
	}
	const MyTypeArrVerticesNeighboursGroup * MyClassGroup2DPrimitiveBase::GetPointVerticesNeighboursGroups()const
	{
		return &ArrVerticesNeighboursGroup;
	}

	void MyClassGroup2DPrimitiveBase::Sort2DPrimitive()
	{
		if (m_isSorted) return;
		std::sort(arr2DPrimitive,arr2DPrimitive+num2DPrimitives,CompareForSort);
		m_isSorted=true;
	}
	bool MyClassGroup2DPrimitiveBase::CompareForSort(MyClass2DPrimitive * a, MyClass2DPrimitive * b)
	{

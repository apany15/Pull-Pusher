...
namespace MY_NS_MODEL
{
	...
	MyClassModel::MyClassModel(const MyClassModel & _MyClassModelObj)
	{
		...
		{
			tP=new MyClassGroup2DPrimitive(*(_MyClassModelObj.arrPointGroup2DPrimitive[i]));
	...
	MyClassGroup2DPrimitive * MyClassModel::operator [] (unsigned int num)
	{
		unsigned int size=(unsigned int) arrPointGroup2DPrimitive.size();
		if (size==0) return 0;
	...
	const MyClassGroup2DPrimitive * MyClassModel::operator [] (unsigned int num)const
	{
		unsigned int size=(unsigned int) arrPointGroup2DPrimitive.size();
		if (size==0) return 0;
		if (num>=size) num=size-1;
	...
	unsigned int MyClassModel::GetNumGroup()const
	{
		return (unsigned int) arrPointGroup2DPrimitive.size();
	}
	void MyClassModel::operator = (const MyClassModel & _MyClassModelObj)
	{
		Clear();
		MyClassGroup2DPrimitive * tP;
		unsigned int size=(unsigned int) arrPointGroup2DPrimitive.size();
	...
	void MyClassModel::AddGroup(const MyClassGroup2DPrimitive * _MyClassGroup2DPrimitiveObj)
	{
		MyClassGroup2DPrimitive * tP;
	...
	void MyClassModel::RemoveGroup(unsigned int num)
	{
		unsigned int size=(unsigned int) arrPointGroup2DPrimitive.size();
		if (size==0) return;
		if (num>=size) num=size-1;
	...
	void MyClassModel::FormVerticesNeighboursGroups()
	{
	...
	void MyClassModel::MessageReseive(MyClassMessage _message, MyClassMessageSender * fromWho)
	{
